      ...
      >
        {isLoading ? (
          ...
          <View style={styles.card}>
            ...
            />
            <ToggleRow
              icon={<Newspaper size={20} color={colors.blue} />}
              label="Aankondigingen"
              value={aankondiging}
              onValueChange={(v) => handleToggle('aankondiging', v)}
              disabled={isPending}
              isLast
            />
          </View>
        ...
        <Text variant="caption" style={styles.caption}>
          Herinneringen worden 24 uur van tevoren verstuurd. Bardienst-herinneringen worden 48 uur van tevoren verstuurd. Aankondigingen worden direct verstuurd zodra ze gepubliceerd worden.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
