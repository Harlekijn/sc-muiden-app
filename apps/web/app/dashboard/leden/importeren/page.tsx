...
export default function ImporterenPage() {
  return (
    <div>
      ...
      <h1 style={s.heading}>Leden importeren</h1>
      <p style={s.desc}>
        Importeer leden vanuit een ClubBase-CSV-export. Controleer de kolomkoppeling en bekijk een preview voor het importeren.
      </p>
      <CsvImportWizard />
    </div>
  );
